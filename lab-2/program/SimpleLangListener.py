...
class SimpleLangListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SimpleLangParser#LogicalNot.
    def enterLogicalNot(self, ctx:SimpleLangParser.LogicalNotContext):
        pass

    # Exit a parse tree produced by SimpleLangParser#LogicalNot.
    ...
    # Enter a parse tree produced by SimpleLangParser#LogicalOp.
    def enterLogicalOp(self, ctx:SimpleLangParser.LogicalOpContext):
        pass

    # Exit a parse tree produced by SimpleLangParser#LogicalOp.
